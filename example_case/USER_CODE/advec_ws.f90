...
!-- all non-prognostic grid points.
    DO  i = nxl, nxr
       DO  j = nys, nyn
          DO  k = nzb+1, nzt
             IF ( .NOT.  BTEST(topo_flags(k,j,i),0) )  CYCLE
!
!--          scalar - x-direction
!--          WS1 (0), WS3 (1), WS5 (2)
             IF ( ( .NOT. BTEST(topo_flags(k,j,i+1),0)              .OR.                           &
                    .NOT. BTEST(topo_flags(k,j,i+2),0)              .OR.                           &
                    .NOT. BTEST(topo_flags(k,j,i-1),0) )            .OR.                           &
                    ( non_cyclic_l  .AND.  i == 0  )                .OR.                           &
                    ( non_cyclic_r  .AND.  i == nx ) )                                             &
             THEN
                advc_flag(k,j,i) = IBSET( advc_flag(k,j,i), 0 )
             ELSEIF ( ( .NOT. BTEST(topo_flags(k,j,i+3),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i+1),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i+2),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i-1),0)                                         &
                      )                       .OR.                                                 &
                      ( .NOT. BTEST(topo_flags(k,j,i-2),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i+1),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i+2),0)          .AND.                          &
                              BTEST(topo_flags(k,j,i-1),0)                                         &
                      )                       .OR.                                                 &
             ...
             ELSEIF ( BTEST(topo_flags(k,j,i+1),0)                  .AND.                          &
                      BTEST(topo_flags(k,j,i+2),0)                  .AND.                          &
                      BTEST(topo_flags(k,j,i+3),0)                  .AND.                          &
                      BTEST(topo_flags(k,j,i-1),0)                  .AND.                          &
                      BTEST(topo_flags(k,j,i-2),0) )                                               &
             THEN
...
!--          WS1 (3), WS3 (4), WS5 (5)                                                  
             IF ( ( .NOT. BTEST(topo_flags(k,j+1,i),0)              .OR.                           &
                    .NOT. BTEST(topo_flags(k,j+2,i),0)              .OR.                           &
                    .NOT. BTEST(topo_flags(k,j-1,i),0))             .OR.                           &
...
!
!--          WS3
             ELSEIF ( ( .NOT. BTEST(topo_flags(k,j+3,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j+1,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j+2,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j-1,i),0)                                         &
                      )                       .OR.                                                 &
                      ( .NOT. BTEST(topo_flags(k,j-2,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j+1,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j+2,i),0)          .AND.                          &
                              BTEST(topo_flags(k,j-1,i),0)                                         &
                      )                       .OR.                                                 &
...
!--          WS5
             ELSEIF ( BTEST(topo_flags(k,j+1,i),0)                  .AND.                          &
                      BTEST(topo_flags(k,j+2,i),0)                  .AND.                          &
                      BTEST(topo_flags(k,j+3,i),0)                  .AND.                          &
                      BTEST(topo_flags(k,j-1,i),0)                  .AND.                          &
                      BTEST(topo_flags(k,j-2,i),0) )                                               &
             THEN
...
!--          WS1 (6), WS3 (7), WS5 (8)
             ...
             flag_set = .FALSE.
             IF ( ( .NOT. BTEST(topo_flags(k-1,j,i),0)               .AND.                         &
                          BTEST(topo_flags(k,j,i),0)                 .AND.                         &
                          BTEST(topo_flags(k+1,j,i),0) )             .OR.                          &
                  ( .NOT. BTEST(topo_flags(k_pp,j,i),0)              .AND.                         &
                          BTEST(topo_flags(k+1,j,i),0)               .AND.                         &
                          BTEST(topo_flags(k,j,i),0) )               .OR.                          &
                  ( k == nzt .AND. symmetry_flag == 0 ) )                                          &
             THEN
                advc_flag(k,j,i) = IBSET( advc_flag(k,j,i), 6 )
                flag_set = .TRUE.
             ELSEIF ( ( .NOT. BTEST(topo_flags(k_mm,j,i),0)          .OR.                          &
                        .NOT. BTEST(topo_flags(k_ppp,j,i),0) )       .AND.                         &
                              BTEST(topo_flags(k-1,j,i),0)           .AND.                         &
                              BTEST(topo_flags(k,j,i),0)             .AND.                         &
                              BTEST(topo_flags(k+1,j,i),0)           .AND.                         &
                              BTEST(topo_flags(k_pp,j,i),0)          .AND.                         &
                        .NOT. flag_set                               .OR.                          &
                      ( k == nzt - 1 .AND. symmetry_flag == 0 ) )                                  &
             THEN
                advc_flag(k,j,i) = IBSET( advc_flag(k,j,i), 7 )
                flag_set = .TRUE.
             ELSEIF ( BTEST(topo_flags(k_mm,j,i),0)                  .AND.                         &
                      BTEST(topo_flags(k-1,j,i),0)                   .AND.                         &
                      BTEST(topo_flags(k,j,i),0)                     .AND.                         &
                      BTEST(topo_flags(k+1,j,i),0)                   .AND.                         &
                      BTEST(topo_flags(k_pp,j,i),0)                  .AND.                         &
                      BTEST(topo_flags(k_ppp,j,i),0)                 .AND.                         &
                     .NOT. flag_set )                                                              &
             THEN
...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE advec_s_ws_ij( advc_flag, i, j, sk, sk_char, swap_flux_y_local, swap_diss_y_local,     &
    ...
    REAL(wp) ::  flux_ud
    REAL(wp) ::  flux_vd
    REAL(wp), DIMENSION(nzb:nzt+1) ::  diss_ut
    REAL(wp), DIMENSION(nzb:nzt+1) ::  diss_vt
    REAL(wp), DIMENSION(nzb:nzt+1) ::  flux_ut
    REAL(wp), DIMENSION(nzb:nzt+1) ::  flux_vt
    ! EOC - Xu
...
!-- tendency at the first w-level. For topography wall this is done implicitely by advc_flag.
    ...
    ! BOC - Xu
    u_comp = ( u(nzb,j,i+1) + u(nzb,j,i) ) * 0.5_wp - u_gtrans + u_stokes_zu(nzb) ! gtrans ???
    v_comp = ( v(nzb,j+1,i) + v(nzb,j,i) ) * 0.5_wp - v_gtrans + v_stokes_zu(nzb)

    ! use 1st scheme at bottom, no diss term due to Neumann condition
    flux_t(nzb) = w(nzb,j,i) * rho_air_zw(nzb) * ( sk(nzb+1,j,i) + sk(nzb,j,i) ) * adv_sca_1
    !flux_t(nzb) = 0.0_wp
    diss_t(nzb) = - ABS(w(nzb,j,i)) * rho_air_zw(nzb) * ( sk(nzb+1,j,i) - sk(nzb,j,i) ) * adv_sca_1

    !WRITE(*,*) "w0: ", w(0,j,i), " w1: ", w(1,j,i), " s0: ", sk(0,j,i), " s1: ", sk(1,j,i), " s2: ", sk(2,j,i)
    !WRITE(*,*) "flux_t(0): ", flux_t(0), " flux_t(1): ", w(nzb+1,j,i) * rho_air_zw(nzb+1) * (sk(nzb+1,j,i) + sk(nzb+2,j,i)) * adv_sca_1

    flux_ut(nzb) = u_comp * rho_air_zw(nzb) * ( sk(nzb+1,j,i) + sk(nzb,j,i) ) * adv_sca_1
    flux_vt(nzb) = v_comp * rho_air_zw(nzb) * ( sk(nzb+1,j,i) + sk(nzb,j,i) ) * adv_sca_1
    !flux_ut(nzb) = 0.0_wp
    !flux_vt(nzb) = 0.0_wp
    diss_ut(nzb) = - ABS(u_comp) * rho_air_zw(nzb) * ( sk(nzb+1,j,i) - sk(nzb,j,i) ) * adv_sca_1
    diss_vt(nzb) = - ABS(v_comp) * rho_air_zw(nzb) * ( sk(nzb+1,j,i) - sk(nzb,j,i) ) * adv_sca_1
    ! EOC - Xu

    DO  k = nzb+1, nzb+1

       ! BOC - Xu
       u_comp = ( u(k+1,j,i+1) + u(k+1,j,i) + u(k,j,i+1) + u(k,j,i) ) * 0.25_wp                    &
                - u_gtrans + u_stokes_zu(k)
       v_comp = ( v(k+1,j+1,i) + v(k+1,j,i) + v(k,j+1,i) + v(k,j,i) ) * 0.25_wp                    &
                - v_gtrans + v_stokes_zu(k)
       ! EOC - Xu
...
!--    k index has to be modified near bottom and top, else array subscripts will be exceeded.
       ...
       diss_ut(k) = - ABS( u_comp )   * rho_air_zw(k) * (                                          &
                   (  10.0_wp * ibit8 * adv_sca_5                                                  &
                   +   3.0_wp * ibit7 * adv_sca_3                                                  &
                   +            ibit6 * adv_sca_1 ) * ( sk(k+1,j,i)   - sk(k,j,i)    )             &
                   - ( 5.0_wp * ibit8 * adv_sca_5                                                  &
       ...
       diss_vt(k) = - ABS( v_comp )   * rho_air_zw(k) * (                                          &
                   (  10.0_wp * ibit8 * adv_sca_5                                                  &
                   +   3.0_wp * ibit7 * adv_sca_3                                                  &
                   +            ibit6 * adv_sca_1 ) * ( sk(k+1,j,i)   - sk(k,j,i)    )             &
                   - ( 5.0_wp * ibit8 * adv_sca_5                                                  &
...
!-- zero.
    ...
    IF ( symmetry_flag == 1 ) THEN
       ...
       diss_vt(nzt) = 0.0_wp
    ENDIF
    u_comp = ( u(nzt+1,j,i+1) + u(nzt+1,j,i) ) * 0.5_wp - u_gtrans + u_stokes_zu(nzt+1)
    v_comp = ( v(nzt+1,j+1,i) + v(nzt+1,j,i) ) * 0.5_wp - v_gtrans + v_stokes_zu(nzt+1)
    flux_t(nzt+1) = 0.0_wp  
    diss_t(nzt+1) = 0.0_wp
    !flux_ut(nzt+1) = 0.0_wp
    !diss_ut(nzt+1) = 0.0_wp
    !flux_vt(nzt+1) = 0.0_wp
    !diss_vt(nzt+1) = 0.0_wp
    !WRITE(*,*) "sk(nzt+1): ", sk(nzt+1,j,i)
    flux_ut(nzt+1) = u_comp * rho_air_zw(nzt+1) * sk(nzt+1,j,i) * adv_sca_1
    diss_ut(nzt+1) = 0.0_wp
    flux_vt(nzt+1) = v_comp * rho_air_zw(nzt+1) * sk(nzt+1,j,i) * adv_sca_1
    diss_vt(nzt+1) = 0.0_wp
...
!--       fluxes equal the original ones.
    ...
    !WRITE(*,*) "flux_t(0): ", flux_t(nzb), " flux_t(1): ", flux_t(nzb+1)
!
...
!--    topography.
       ...
       ! BOC - Xu
          div      =   ( u(k,j,i+1) * ( ibit0 + ibit1 + ibit2 )                                    &
                     ...
                     + ( ( u(k+1,j,i+1) + u(k+1,j,i) + u(k,j,i+1) + u(k,j,i) ) * 0.25_wp           &
                                    * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )                    &
                       - ( u(k-1,j,i+1) + u(k-1,j,i) ) * 0.5_wp                                    &
                                    * rho_air_zw(k-1)                                              &
                       ) * drho_air(k) * ddzzw(k) * dzeta_dx_s(k,j,i)                              &
                     ...
                     + ( ( v(k+1,j+1,i) + v(k+1,j,i) + v(k,j+1,i) + v(k,j,i) ) * 0.25_wp           &
                                    * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )                    &
                       - ( v(k-1,j+1,i) + v(k-1,j,i) ) * 0.5_wp                                    &
                                    * rho_air_zw(k-1)                                              &
                       ) * drho_air(k) * ddzzw(k) * dzeta_dy_s(k,j,i)                              &
                     + ( w(k,j,i)   * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )                    &
                       - w(k-1,j,i) * rho_air_zw(k-1)                                              &
                       ) * drho_air(k) * ddzzw(k) * dzeta_dz_s(j,i)
       ELSE
          div      =   ( u(k,j,i+1) * ( ibit0 + ibit1 + ibit2 )                                    &
                       - u(k,j,i)   * (                                                            &
                       REAL( IBITS(advc_flag(k,j,i-1),0,1), KIND = wp )                            &
       ...
       tend(k,j,i) = tend(k,j,i) - (                                                               &
                       ( ( sk(k+1,j,i) + sk(k,j,i) ) * rho_air_zw(k)                               &
                     -   ( sk(k-1,j,i) + sk(k,j,i) ) * rho_air_zw(k-1)                             &
                       ) * 0.5_wp * dzeta_dt_s(k,j,i) * drho_air(k) * ddzzw(k)                     &
                     ...
                     + ( ( ( flux_ut(k) + diss_ut(k) )                                             &
                     -     ( flux_ud    + diss_ud    ) ) * dzeta_dx_s(k,j,i)                       &
                     +   ( ( flux_vt(k) + diss_vt(k) )                                             &
                     -     ( flux_vd    + diss_vd    ) ) * dzeta_dy_s(k,j,i)                       &
                     +   ( ( flux_t(k)  + diss_t(k)  )                                             &
                     -     ( flux_d     + diss_d     ) ) * dzeta_dz_s(j,i)                         &
                       )             * drho_air(k) * ddzzw(k)                                      &
                                   ) + sk(k,j,i) * div
       ! EOC - Xu
...
!-- Compute southside fluxes for the respective boundary of PE
    IF ( j == nys  )  THEN
       ...
       DO  k = nzb+1, nzb_max_l
          ...
          ! BOC - DEBUG
          !WRITE(*,*) "ibit3: ", ibit3, " ibit4, ", ibit4, " ibit5: ", ibit5
          ! EOC - DEBUG
...
!-- tendency at the first w-level. For topography wall this is done implicitely by advc_flags_m.
    ...
    ! BOC - Xu
    u_comp(nzb) = u(nzb,j,i) * 2.0_wp - gu
    v_comp(nzb) = ( v(nzb,j,i) + v(nzb,j,i-1) + v(nzb,j+1,i) + v(nzb,j+1,i-1) - 2.0_wp * gv ) * 0.5_wp
    w_comp(nzb) = w(nzb,j,i) + w(nzb,j,i-1)

    flux_t(nzb) = w_comp(nzb) * ( u(nzb+1,j,i) + u(nzb,j,i) ) * rho_air_zw(nzb) * adv_mom_1
    diss_t(nzb) = 0.0_wp

    flux_ut(nzb) = u_comp(nzb) * ( u(nzb+1,j,i) + u(nzb,j,i) ) * rho_air_zw(nzb) * adv_mom_1
    flux_vt(nzb) = v_comp(nzb) * ( u(nzb+1,j,i) + u(nzb,j,i) ) * rho_air_zw(nzb) * adv_mom_1
    diss_ut(nzb) = 0.0_wp
    diss_vt(nzb) = 0.0_wp
    ! EOC - Xu
...
!--    k index has to be modified near bottom and top, else array subscripts will be exceeded.
       ...
       ! BOC - Xu
       flux_ut(k) = ( u(k+1,j,i) + u(k,j,i) - gu ) * rho_air_zw(k) * (                             &
                    (  37.0_wp * ibit8 * adv_mom_5                                                 &
                    +   7.0_wp * ibit7 * adv_mom_3                                                 &
                    +            ibit6 * adv_mom_1 ) * ( u(k+1,j,i)   + u(k,j,i)    )              &
                    - ( 8.0_wp * ibit8 * adv_mom_5                                                 &
       ...
       diss_ut(k) = - ABS( u(k+1,j,i) + u(k,j,i) - gu ) * rho_air_zw(k) * (                        &
                    (  10.0_wp * ibit8 * adv_mom_5                                                 &
                    +   3.0_wp * ibit7 * adv_mom_3                                                 &
                    +            ibit6 * adv_mom_1 ) * ( u(k+1,j,i)   - u(k,j,i)    )              &
                    - ( 5.0_wp * ibit8 * adv_mom_5                                                 &
       ...
       flux_vt(k) = ( v(k+1,j,i) + v(k+1,j+1,i) + v(k+1,j+1,i-1) + v(k+1,j,i-1)                    &
                    + v(k,j,i)   + v(k,j+1,i)   + v(k,j+1,i-1)   + v(k,j,i-1)                      &
                    - 4.0_wp * gv ) * 0.25_wp * rho_air_zw(k) * (                                  &
                    (  37.0_wp * ibit8 * adv_mom_5                                                 &
                    +   7.0_wp * ibit7 * adv_mom_3                                                 &
                    +            ibit6 * adv_mom_1 ) * ( u(k+1,j,i)   + u(k,j,i)    )              &
                    - ( 8.0_wp * ibit8 * adv_mom_5                                                 &
       ...
       diss_vt(k) = - ABS( v(k+1,j,i) + v(k+1,j+1,i) + v(k+1,j+1,i-1) + v(k+1,j,i-1)               &
                         + v(k,j,i)   + v(k,j+1,i)   + v(k,j+1,i-1)   + v(k,j,i-1)                 &
                    - 4.0_wp * gv ) * 0.25_wp * rho_air_zw(k) * (                                  &
                    (  10.0_wp * ibit8 * adv_mom_5                                                 &
                    +   3.0_wp * ibit7 * adv_mom_3                                                 &
...
!-- zero.
    ...
    u_comp(nzt+1) = u(nzt+1,j,i) * 2.0_wp - gu
    v_comp(nzt+1) = ( v(nzt+1,j,i) + v(nzt+1,j,i-1) + v(nzt+1,j+1,i) + v(nzt+1,j+1,i-1) - 2.0_wp * gv ) * 0.5_wp
    flux_ut(nzt+1) = u_comp(nzt+1) * rho_air_zw(nzt+1) * 2.0_wp * u(nzt+1,j,i) * adv_mom_1
    diss_ut(nzt+1) = 0.0_wp
    flux_vt(nzt+1) = v_comp(nzt+1) * rho_air_zw(nzt+1) * 2.0_wp * u(nzt+1,j,i) * adv_mom_1
    diss_vt(nzt+1) = 0.0_wp

    !WRITE(*,*) "u(nzt+1): ", u(nzt+1,j,i)
    ! EOC - Xu
...
!--    topography.
       ...
       IF ( k==1 ) THEN
          div = ( ( u_comp(k)       * ( ibit0 + ibit1 + ibit2 )                                    &
             ...
             + ( ( u(k+1,j,i)  + u(k,j,i)  ) * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )           &
               - 2.0_wp * u(k-1,j,i) * rho_air_zw(k-1)                                                      &
               ) * drho_air(k) * ddzzw(k) * dzeta_dx_u(k,j,i)                                      &
             ...
             + ( ( v(k+1,j,i) + v(k+1,j+1,i) + v(k+1,j+1,i-1) + v(k+1,j,i-1)                       &
                 + v(k,j,i)   + v(k,j+1,i)   + v(k,j+1,i-1)   + v(k,j,i-1)   )                     &
                      * 0.25_wp * rho_air_zw(k)   * ( ibit6 + ibit7 + ibit8 )                      &
               - ( v(k-1,j,i) + v(k-1,j+1,i) + v(k-1,j+1,i-1) + v(k-1,j,i-1) )                     &
                      * 0.5_wp  * rho_air_zw(k-1)                                                  &
               ) * drho_air(k) * ddzzw(k) * dzeta_dy_u(k,j,i)                                      &
             + ( w_comp(k)   * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )                           &
             -   w_comp(k-1) * rho_air_zw(k-1)                                                     &
               ) * drho_air(k) * ddzzw(k) * dzeta_dz_u(j,i)                                        &
             ) * 0.5_wp
       ELSE
          div = ( ( u_comp(k)       * ( ibit0 + ibit1 + ibit2 )                                    &
             - ( u(k,j,i)   + u(k,j,i-1)   )                                                       &
             ...
             + ( ( u(k+1,j,i)  + u(k,j,i)  ) * rho_air_zw(k) * ( ibit6 + ibit7 + ibit8 )           &
               - ( u(k,j,i)    + u(k-1,j,i)) * rho_air_zw(k-1)                                     &
                                 * (                                                               &
             ...
             + ( ( v(k+1,j,i) + v(k+1,j+1,i) + v(k+1,j+1,i-1) + v(k+1,j,i-1)                       &
                 + v(k,j,i)   + v(k,j+1,i)   + v(k,j+1,i-1)   + v(k,j,i-1)   )                     &
                      * 0.25 * rho_air_zw(k)   * ( ibit6 + ibit7 + ibit8 )                         &
               - ( v(k,j,i)   + v(k,j+1,i)   + v(k,j+1,i-1)   + v(k,j,i-1)                         &
                 + v(k-1,j,i) + v(k-1,j+1,i) + v(k-1,j+1,i-1) + v(k-1,j,i-1) )                     &
                      * 0.25 * rho_air_zw(k-1)                                                     &
                                 * (                                                               &
       ...
       tend(k,j,i) = tend(k,j,i) - (                                                               &
                         ( ( u(k+1,j,i) + u(k,j,i) ) * rho_air_zw(k)                               &
                       -   ( u(k-1,j,i) + u(k,j,i) ) * rho_air_zw(k-1)                             &
                         ) * 0.5_wp * dzeta_dt_u(k,j,i) * drho_air(k) * ddzzw(k)                   &
                       + ( flux_r(k) + diss_r(k)                                                   &
                       -   flux_l_u(k,j,tn) - diss_l_u(k,j,tn) ) * ddx                             &
                       + ( flux_n(k) + diss_n(k)                                                   &
                       -   flux_s_u(k,tn) - diss_s_u(k,tn)     ) * ddy                             &
                       + ( ( ( flux_ut(k) + diss_ut(k) )                                           &
                       -     ( flux_ud    + diss_ud    ) ) * dzeta_dx_u(k,j,i)                     &
                       +   ( ( flux_vt(k) + diss_vt(k) )                                           &
                       -     ( flux_vd    + diss_vd    ) ) * dzeta_dy_u(k,j,i)                     &
                       +   ( ( flux_t(k) + diss_t(k)   )                                           &
                       -     ( flux_d    + diss_d      ) ) * dzeta_dz_u(j,i)                       &
                         )                         * drho_air(k) * ddzzw(k)                        &
                                   ) + div * u(k,j,i)

       ! BOC - DEBUG
       !IF ( k==1 ) THEN
       !   WRITE(*,*) "flux: ", (flux_t(k) + diss_t(k) - flux_d - diss_d) * dzeta_dz_u(j,i) * drho_air(k) * ddzzw(k)
       !ENDIF
       ! EOC - DEBUG
...
!--    tendency at the first w-level. For topography wall this is done implicitely by advc_flags_m.
    ...
    ! BOC - Xu
    u_comp(nzb) = ( u(nzb,j,i) + u(nzb,j,i+1) + u(nzb,j-1,i) + u(nzb,j-1,i+1) - 2.0_wp * gu ) * 0.5_wp
    v_comp(nzb) = v(nzb,j,i) * 2.0_wp - gv
    w_comp(nzb) = w(nzb,j-1,i) + w(nzb,j,i)

    flux_t(nzb) = w_comp(nzb) * rho_air_zw(nzb) * ( v(nzb+1,j,i) + v(nzb,j,i) ) * adv_mom_1
    diss_t(nzb) = 0.0_wp

    flux_ut(nzb) = u_comp(nzb) * rho_air_zw(nzb) * ( v(nzb+1,j,i) + v(nzb,j,i) ) * adv_mom_1
    flux_vt(nzb) = v_comp(nzb) * rho_air_zw(nzb) * ( v(nzb+1,j,i) + v(nzb,j,i) ) * adv_mom_1
    diss_ut(nzb) = 0.0_wp
    diss_vt(nzb) = 0.0_wp
    ! EOC - Xu
...
!--    subscripts will be exceeded.
       ...
       ! BOC - Xu
       flux_ut(k) = ( u(k+1,j,i) + u(k+1,j-1,i) + u(k+1,j-1,i+1) + u(k+1,j,i+1)                    &
                    + u(k,j,i)   + u(k,j-1,i)   + u(k,j-1,i+1)   + u(k,j,i+1)                      &
                    - 4.0_wp * gu ) * 0.25_wp * rho_air_zw(k) * (                                  &
                    (  37.0_wp * ibit17 * adv_mom_5                                                &
                    +   7.0_wp * ibit16 * adv_mom_3                                                &
                    +            ibit15 * adv_mom_1 ) * ( v(k+1,j,i)   + v(k,j,i)    )             &
                    - ( 8.0_wp * ibit17 * adv_mom_5                                                &
       ...
       diss_ut(k) = - ABS( u(k+1,j,i) + u(k+1,j-1,i) + u(k+1,j-1,i+1) + u(k+1,j,i+1)               &
                    + u(k,j,i)   + u(k,j-1,i)   + u(k,j-1,i+1)   + u(k,j,i+1)                      &
                    - 4.0_wp * gu ) * 0.25_wp * rho_air_zw(k) * (                                  &
                    (  10.0_wp * ibit17 * adv_mom_5                                                &
                    +   3.0_wp * ibit16 * adv_mom_3                                                &
       ...
       flux_vt(k) = ( v(k+1,j,i) + v(k,j,i) - gv ) * rho_air_zw(k) * (                             &
                    (  37.0_wp * ibit17 * adv_mom_5                                                &
                    +   7.0_wp * ibit16 * adv_mom_3                                                &
                    +            ibit15 * adv_mom_1 ) * ( v(k+1,j,i)   + v(k,j,i)    )             &
                    - ( 8.0_wp * ibit17 * adv_mom_5                                                &
       ...
       diss_vt(k) = - ABS( v(k+1,j,i) + v(k,j,i) - gv ) * rho_air_zw(k) * (                        &
                    (  10.0_wp * ibit17 * adv_mom_5                                                &
                    +   3.0_wp * ibit16 * adv_mom_3                                                &
                    +            ibit15 * adv_mom_1 ) * ( v(k+1,j,i)   - v(k,j,i)    )             &
                    - ( 5.0_wp * ibit17 * adv_mom_5                                                &
...
!-- zero.
    ...
    u_comp(nzt+1) = ( u(nzt+1,j,i) + u(nzt+1,j-1,i) + u(nzt+1,j,i+1) + u(nzt+1,j-1,i+1) - 2.0_wp * gu ) * 0.5_wp
    v_comp(nzt+1) = v(nzt+1,j,i) * 2.0_wp - gv 
    flux_ut(nzt+1) = u_comp(nzt+1) * rho_air_zw(nzt+1) * 2.0_wp * v(nzt+1,j,i) * adv_mom_1
    diss_ut(nzt+1) = 0.0_wp
    flux_vt(nzt+1) = v_comp(nzt+1) * rho_air_zw(nzt+1) * 2.0_wp * v(nzt+1,j,i) * adv_mom_1
    diss_vt(nzt+1) = 0.0_wp

    !WRITE(*,*) "v(nzt+1): ", v(nzt+1,j,i)
    ! EOC - Xu
...
!--    topography.
       ...
       IF ( k==1 ) THEN
          div = ( ( ( u_comp(k)     + gu )                                                            &
             ...
             + ( ( u(k+1,j,i) + u(k+1,j-1,i) + u(k+1,j-1,i+1) + u(k+1,j,i+1)                       &
                 + u(k,j,i)   + u(k,j-1,i)   + u(k,j-1,i+1)   + u(k,j,i+1)   )                     &
                      * 0.25_wp * rho_air_zw(k)   * ( ibit15 + ibit16 + ibit17 )                   &
               - ( u(k-1,j,i) + u(k-1,j-1,i) + u(k-1,j-1,i+1) + u(k-1,j,i+1) )                     &
                      * 0.50_wp * rho_air_zw(k-1)                                                  &
               ) * drho_air(k) * ddzzw(k) * dzeta_dx_v(k,j,i)                                      &
             + ( v_comp(k)                                                                         &
             ...
             + ( ( v(k+1,j,i)  + v(k,j,i)  ) * rho_air_zw(k) * ( ibit15 + ibit16 + ibit17 )        &
               - 2.0_wp * v(k-1,j,i) * rho_air_zw(k-1)                                             &
               ) * drho_air(k) * ddzzw(k) * dzeta_dy_v(k,j,i)                                      &
             + ( w_comp(k)   * rho_air_zw(k) * ( ibit15 + ibit16 + ibit17 )                        &
             -   w_comp(k-1) * rho_air_zw(k-1)                                                     &
               ) * drho_air(k) * ddzzw(k) * dzeta_dz_v(j,i)                                        &
             ) * 0.5_wp
       ELSE
          div = ( ( ( u_comp(k)     + gu )                                                         &
                                    * ( ibit9 + ibit10 + ibit11 )                                  &
             ...
             + ( ( u(k+1,j,i) + u(k+1,j-1,i) + u(k+1,j-1,i+1) + u(k+1,j,i+1)                       &
                 + u(k,j,i)   + u(k,j-1,i)   + u(k,j-1,i+1)   + u(k,j,i+1)   )                     &
                      * 0.25 * rho_air_zw(k)   * ( ibit15 + ibit16 + ibit17 )                      &
               - ( u(k,j,i)   + u(k,j-1,i)   + u(k,j-1,i+1)   + u(k,j,i+1)                         &
                 + u(k-1,j,i) + u(k-1,j-1,i) + u(k-1,j-1,i+1) + u(k-1,j,i+1) )                     &
                      * 0.25 * rho_air_zw(k-1)                                                     &
                                 * (                                                               &
             ...
             + ( ( v(k+1,j,i)  + v(k,j,i)  ) * rho_air_zw(k) * ( ibit15 + ibit16 + ibit17 )        &
               - ( v(k,j,i)    + v(k-1,j,i)) * rho_air_zw(k-1)                                     &
                                 * (                                                               &
                  REAL( IBITS(advc_flags_m(k-1,j,i),15,1), KIND = wp )                             &
                + REAL( IBITS(advc_flags_m(k-1,j,i),16,1), KIND = wp )                             &
                + REAL( IBITS(advc_flags_m(k-1,j,i),17,1), KIND = wp )                             &
       ...
       tend(k,j,i) = tend(k,j,i) - (                                                               &
                      ( ( v(k+1,j,i) + v(k,j,i) ) * rho_air_zw(k)                                  &
                    -   ( v(k-1,j,i) + v(k,j,i) ) * rho_air_zw(k-1)                                &
                      ) * 0.5_wp * dzeta_dt_v(k,j,i) * drho_air(k) * ddzzw(k)                      &
                    + ( flux_r(k) + diss_r(k)                                                      &
                    -   flux_l_v(k,j,tn) - diss_l_v(k,j,tn)   ) * ddx                              &
                    + ( flux_n(k) + diss_n(k)                                                      &
                    -   flux_s_v(k,tn) - diss_s_v(k,tn)       ) * ddy                              &
                    + ( ( ( flux_ut(k) + diss_ut(k) )                                              &
                    -     ( flux_ud    + diss_ud    ) ) * dzeta_dx_v(k,j,i)                        &
                    +   ( ( flux_vt(k) + diss_vt(k) )                                              &
                    -     ( flux_vd    + diss_vd    ) ) * dzeta_dy_v(k,j,i)                        &
                    +   ( ( flux_t(k) + diss_t(k)   )                                              &
                    -     ( flux_d    + diss_d      ) ) * dzeta_dz_v(j,i)                          &
                      )                           * drho_air(k) * ddzzw(k)                         &
                                   ) + v(k,j,i) * div
       ! EOC - Xu
...
!--    First, compute flux at lowest level, located at z=dz/2.
    ...
    ! BOC - Xu
    flux_ut(0) = ( u(k,j,i+1) + u(k,j,i) - gu ) * rho_air(k) * ( w(k,j,i) + w(k-1,j,i) ) * adv_mom_1
    flux_vt(0) = ( v(k,j+1,i) + v(k,j,i) - gv ) * rho_air(k) * ( w(k,j,i) + w(k-1,j,i) ) * adv_mom_1
    diss_ut(0) = - ABS(u(k,j,i+1) + u(k,j,i) - gu) * rho_air(k) * ( w(k,j,i) - w(k-1,j,i) ) * adv_mom_1
    diss_vt(0) = - ABS(v(k,j+1,i) + v(k,j,i) - gv) * rho_air(k) * ( w(k,j,i) - w(k-1,j,i) ) * adv_mom_1

    !IF ( j==5 .AND. i==5) THEN
    !   WRITE(*,*) "w(nzb): ", w(nzb,j,i)
    !ENDIF
    ! EOC - Xu
...
!--    k index has to be modified near bottom and top, else array subscripts will be exceeded.
       ...
       ! BOC - Xu
       flux_ut(k) = ( u(k+1,j,i+1) + u(k+1,j,i) - gu ) * rho_air(k+1) * (                          &
                    (  37.0_wp * ibit26 * adv_mom_5                                                &
                    +   7.0_wp * ibit25 * adv_mom_3                                                &
                    +            ibit24 * adv_mom_1 ) * ( w(k+1,j,i)   + w(k,j,i)    )             &
                    - ( 8.0_wp * ibit26 * adv_mom_5                                                &
       ...
       diss_ut(k) = - ABS( u(k+1,j,i+1) + u(k+1,j,i) - gu ) * rho_air(k+1) * (                     &
                    (  10.0_wp * ibit26 * adv_mom_5                                                &
                    +   3.0_wp * ibit25 * adv_mom_3                                                &
                    +            ibit24 * adv_mom_1 ) * ( w(k+1,j,i)   - w(k,j,i)    )             &
                    - ( 5.0_wp * ibit26 * adv_mom_5                                                &
       ...
       flux_vt(k) = ( v(k+1,j+1,i) + v(k+1,j,i) - gv ) * rho_air(k+1) * (                          &
                    (  37.0_wp * ibit26 * adv_mom_5                                                &
                    +   7.0_wp * ibit25 * adv_mom_3                                                &
                    +            ibit24 * adv_mom_1 ) * ( w(k+1,j,i)   + w(k,j,i)    )             &
                    - ( 8.0_wp * ibit26 * adv_mom_5                                                &
       ...
       diss_vt(k) = - ABS( v(k+1,j+1,i) + v(k+1,j,i) - gv ) * rho_air(k+1) * (                     &
                    (  10.0_wp * ibit26 * adv_mom_5                                                &
                    +   3.0_wp * ibit25 * adv_mom_3                                                &
                    +            ibit24 * adv_mom_1 ) * ( w(k+1,j,i)   - w(k,j,i)    )             &
                    - ( 5.0_wp * ibit26 * adv_mom_5                                                &
...
!-- domain.
    ...
    !u_comp(nzt+1) = ( u(nzt+1,j,i) + u(nzt+1,j-1,i) + u(nzt+1,j,i+1) + u(nzt+1,j-1,i+1) - 2.0_wp * gu ) * 0.5_wp
    !v_comp(nzt+1) = v(nzt+1,j,i) * 2.0_wp - gv
    !flux_ut(nzt+1) = u_comp(nzt+1) * rho_air_zw(nzt+1) * v(nzt+1,j,i)
    !diss_ut(nzt+1) = 0.0_wp
    !flux_vt(nzt+1) = v_comp(nzt+1) * rho_air_zw(nzt+1) * v(nzt+1,j,i)
    !diss_vt(nzt+1) = 0.0_wp

    !IF ( j==5 .AND. i==5) THEN
       !WRITE(*,*) "w(nzt+1): ", w(nzt+1,j,i)
    !ENDIF
    ! EOC - Xu
...
!--    topography.
       ...
       IF ( k==1 ) THEN
          div = ( ( ( u_comp(k) + gu ) * ( ibit18 + ibit19 + ibit20 )                              &
             ...
             + ( ( u(k+1,j,i+1) + u(k+1,j,i) ) * rho_air(k+1) * ( ibit24 + ibit25 + ibit26 )       &
               - ( u(k,j,i+1)   + u(k,j,i)   ) * rho_air(k)                                        &
               ) * drho_air_zw(k) * ddzzu(k+1) * dzeta_dx_w(k,j,i)                                 &
             ...
             + ( ( v(k+1,j+1,i) + v(k+1,j,i) ) * rho_air(k+1) * ( ibit24 + ibit25 + ibit26 )       &
               - ( v(k,j+1,i)   + v(k,j,i)   ) * rho_air(k)                                        &
               ) * drho_air_zw(k) * ddzzu(k+1) * dzeta_dy_w(k,j,i)                                 &
             + ( w_comp(k)               * rho_air(k+1)                                            &
                                         * ( ibit24 + ibit25 + ibit26 )                            &
             - ( w(k,j,i) + w(k-1,j,i) ) * rho_air(k)                                              &
               ) * drho_air_zw(k) * ddzzu(k+1) * dzeta_dz_s(j,i)                                  &
             ) * 0.5_wp
       ELSE
          div = ( ( ( u_comp(k) + gu ) * ( ibit18 + ibit19 + ibit20 )                              &
               - ( u(k+1,j,i) + u(k,j,i)   )                                                       &
       ...
       tend(k,j,i) = tend(k,j,i) - (                                                               &
                     ( ( w(k+1,j,i) + w(k,j,i) ) * rho_air(k+1)                                    &
                   -   ( w(k-1,j,i) + w(k,j,i) ) * rho_air(k)                                      &
                     ) * 0.5_wp * dzeta_dt_w(k,j,i) * drho_air_zw(k) * ddzzu(k+1)                  &
                   + ( flux_r(k) + diss_r(k)                                                       &
                   -   flux_l_w(k,j,tn) - diss_l_w(k,j,tn)   ) * ddx                               &
                   + ( flux_n(k) + diss_n(k)                                                       &
                   -   flux_s_w(k,tn) - diss_s_w(k,tn)       ) * ddy                               &
                   + ( ( ( flux_ut(k) + diss_ut(k) )                                               &
                   -     ( flux_ud    + diss_ud    ) ) * dzeta_dx_w(k,j,i)                         &
                   +   ( ( flux_vt(k) + diss_vt(k) )                                               &
                   -     ( flux_vd    + diss_vd    ) ) * dzeta_dy_w(k,j,i)                         &
                   +   ( ( flux_t(k)  + diss_t(k)  )                                               &
                   -     ( flux_d     + diss_d     ) ) * dzeta_dz_s(j,i)                          &
                     )                        * drho_air_zw(k) * ddzzu(k+1)                        &
                                   ) + div * w(k,j,i)
       ! EOC - Xu
...
!--    topography.
       ...
       div = ( ( u_comp(k) + gu - ( u(k+1,j,i) + u(k,j,i)   ) ) * ddx                              &
             + ( ( u(k+1,j,i+1) + u(k+1,j,i) ) * rho_air(k+1)                                      &
             -   ( u(k,j,i+1)   + u(k,j,i)   ) * rho_air(k)                                        &
               )                               * drho_air_zw(k) * ddzzu(k+1) * dzeta_dx_w(k,j,i)   &
             + ( v_comp(k) + gv - ( v(k+1,j,i) + v(k,j,i)   ) ) * ddy                              &
             + ( ( v(k+1,j+1,i) + v(k+1,j,i) ) * rho_air(k+1)                                      &
             -   ( v(k,j+1,i)   + v(k,j,i)   ) * rho_air(k)                                        &
               )                               * drho_air_zw(k) * ddzzu(k+1) * dzeta_dy_w(k,j,i)   &
             + ( w_comp(k)               * rho_air(k+1)                                            &
             - ( w(k,j,i) + w(k-1,j,i) ) * rho_air(k)                                              &
