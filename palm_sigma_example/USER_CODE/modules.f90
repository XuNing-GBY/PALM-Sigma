...
!--------------------------------------------------------------------------------------------------!
 MODULE arrays_3d
    ...
    ! BOC - Xu
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  dzzu
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  ddzzu
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  ddzzu_pres
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  dd2zzu
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  dzzw
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  ddzzw
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  zzu
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  zzw
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  zzu_mg
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  zzw_mg
    ! EOC - Xu
    ...
    ! BOC - Xu
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  dzzu_mg
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  ddzzu_mg
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  dzzw_mg
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  ddzzw_mg
    ! EOC - Xu
    ...
    ! BOC - Xu
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f4_mg
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f5_mg

    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f1_mg_
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f2_mg_
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f3_mg_
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f4_mg_
    REAL(wp), DIMENSION(:,:), ALLOCATABLE ::  f5_mg_
    ! EOC - Xu
...
!--------------------------------------------------------------------------------------------------!
 MODULE grid_variables
    ...
    ! BOC - Xu
    REAL(wp) ::  H_av
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  ddx_mg
    REAL(wp), DIMENSION(:), ALLOCATABLE ::  ddy_mg
    ! EOC - Xu
